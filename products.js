function Cookie(name, price, image, circImg, description, priceNum, id){
 ...
 const chocChipCookieDough = new Cookie("Cookie Dough", "$12.04", '/public/images/cookiedough.png', "/images/cookiedoughcirc.png", "Our delicious OG chocolate chip cookie batter infused with movie theater chocolate chip cookie dough! ",12.04, 0);
 const chocChip = new Cookie("OG Triple Chocolate Chip", "$12.04", '/public/images/chocchip.png', "/images/chocchipcirc.png", "Keep it ORIGINAL! Our deluctable chocolate chip cookies stuffed with enormous amounts of semi-sweet chocolate chips. ", 12.04, 1);
 const smores = new Cookie("Cookie and Smores", "$12.04", '/public/images/smores.png', "/images/smorescirc.png", "This cookie saves all the hussle and bussle of making a smore and packs TEN TIMES the flavor!", 12.04, 2);
